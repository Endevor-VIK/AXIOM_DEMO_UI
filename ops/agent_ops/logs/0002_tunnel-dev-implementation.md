...
- 2025-12-19T19:55:00+03:00 — Создал обёртку `scripts/run_tunnel_dev_auto.py` (авто старт run_local → ожидание Vite → запуск run_tunnel_dev с hash-file), добавил флаг `--reuse-if-running`, обновил README (авто режим, примеры).
- 2025-12-19T19:53:21+03:00 — Перенёс все dev-скрипты в `scripts/devtools/` (run_local/run_tunnel_dev/run_tunnel_dev_auto/tunnel_auth_helper), добавил `scripts/devtools/README.md` со ссылкой на docs/devtools, обновил README ссылки/команды, проверил `--help` после переноса.
