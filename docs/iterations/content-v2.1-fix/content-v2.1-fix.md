...
- расширил `docs/content/content-authoring-v2.1/content-authoring-v2.1.md` разделом «Telemetry Events Reference» с payload схемами и примером адаптера.
...
**Artifacts:** docs/content/content-authoring-v2.1/content-authoring-v2.1.md; README.md
**Changes:**
- составил новый документ `docs/content/content-authoring-v2.1/content-authoring-v2.1.md` с описанием схемы, renderMode/assetsBase, `data-*` хуков и workflow для авторов.
