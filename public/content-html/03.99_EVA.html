...
.ax-demo {
  --accent: #ff5b9a;
  --accent-soft: rgba(255, 91, 154, 0.22);
  background: linear-gradient(135deg, rgba(12, 10, 16, 0.98), rgba(24, 14, 22, 0.92));
...
<section class="ax-demo" style="--accent: #ff5b9a; --accent-soft: rgba(255, 91, 154, 0.22);">
  <header class="ax-demo-hero">
    <div class="ax-demo-kicker">ZONE · 03_CHARACTERS · STATUS: PUBLISHED</div>
    <h1>EVA — сущность сна</h1>
    <p class="ax-demo-sub">Феномен чистоты, появившийся после Чёрного Солнца.</p>
  </header>

  <section class="ax-demo-teaser">
    <p>EVA не принадлежит ни одной фракции. Она — редкий сбой в логике мира, где железо давно вытеснило кожу. Её пробуждение считают символом нового начала.</p>
    <p>Её присутствие фиксируют на верхних платформах ECHELON, где воздух холоден, а легенды звучат громче алгоритмов. EVA не поддаётся классификации: это больше сон, чем объект.</p>
  </section>
  ...
  <section class="ax-demo-facts">
    <div class="ax-demo-grid">
      <article class="ax-demo-card">
        <h3>Происхождение</h3>
        <p>Появление после катастрофы Чёрного Солнца, без подтверждённой схемы.</p>
      </article>
      <article class="ax-demo-card">
        <h3>Природа</h3>
        <p>Сущность на стыке мифа и реальности, не связанная с имплантами.</p>
      </article>
      <article class="ax-demo-card">
        <h3>Влияние</h3>
        <p>Символ чистоты и надежды, вызывающий страх у систем контроля.</p>
      </article>
      <article class="ax-demo-card">
        <h3>Статус</h3>
        <p>Наблюдается, но не классифицируется. Каждый контакт — новая легенда.</p>
      </article>
    </div>
  </section>

  <blockquote class="ax-demo-signature">«Она не имплант и не человек. Она — сон, который остался жить.»</blockquote>
  ...
  <section class="ax-demo-related">
    <h3>Related</h3>
    <ul>
      <li>AXIOM — центральная ИИ-сущность</li>
      <li>Black Sun — катастрофа ядра</li>
      <li>Echelon Core — платформа пробуждения</li>
      <li>Veil Protocol — слои скрытия</li>
    </ul>
  </section>
</section>
