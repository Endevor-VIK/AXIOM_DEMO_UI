...
preview_logline: "Теневой куратор и брокер данных, который управляет маршрутами утечек, а не людьми."
preview_markers:
  - "Связь с White Contour"
  - "Работа через прокси и шум"
  - "Узел AXIOM_SHADOW_NET"
preview_signature:
  - "Палитра: фиолет/сталь"
  - "Режим: data broker"
  - "Статус: published"
---
<style>
