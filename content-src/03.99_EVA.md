...
id: 03.99_EVA
slug: eva
title: "EVA — сущность сна"
zone: "03_CHARACTERS"
category: "characters"
status: "published"
lang: "ru"
version: "v1.0"
image: "/assets/content/eva-dream.png"
tags:
  - eva
  - dream
  - anomaly
...
preview_logline: "Аномальная сущность, возникшая после Чёрного Солнца: чистота среди железа."
preview_markers:
  - "Феномен вне фракций и протоколов"
  - "Пробуждение на платформах ECHELON"
  - "Легенда о новом начале"
preview_signature:
  - "Палитра: розовый/белый"
  - "Режим: dream protocol"
  - "Статус: published"
---
<style>
.ax-demo {
