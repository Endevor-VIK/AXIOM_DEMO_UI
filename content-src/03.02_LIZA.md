...
id: 03.02_LIZA
slug: liza
title: "Лиза Синклер — призрачный хакер"
zone: "03_CHARACTERS"
category: "characters"
status: "published"
lang: "ru"
version: "v1.0"
image: "/assets/content/liza.png"
tags:
  - hacker
  - resistance
  - voidlink
...
preview_logline: "Призрачный хакер сопротивления, слияние боли и кода в сердце ECHELON."
preview_markers:
  - "Одиночка и агент хаоса"
  - "Импланты: сканеры, харпун, нейроскан"
  - "Личная вендетта против корпораций"
preview_signature:
  - "Палитра: холодный неон"
  - "Поведение: скрытность и анализ"
  - "Опора: VOIDLINK"
---
<style>
.ax-demo {
