...
export type OrionPostConfig = {
  ...
  softLightContrast: number;
  softLightSaturation: number;
  softLightHighlightClamp: number;
...
const BASELINE_CONFIG: OrionLoginRuntimeConfig = {
  ...
  post: {
    ...
    softLightEnabled: false,
    softLightStrength: 0.2,
    softLightContrast: 0.1,
    softLightSaturation: 0.05,
    softLightHighlightClamp: 0.08,
    floorGlowBase: 0.12,
    floorGlowAmp: 0.1,
    laneGlowBase: 0.1,
    laneGlowAmp: 0.12,
...
const PRESET_OVERRIDES: Record<OrionQualityPreset, Partial<OrionLoginRuntimeConfig>> = {
  ultra: {
    ...
    post: {
      ...
      softLightStrength: 0.34,
      softLightContrast: 0.16,
      softLightSaturation: 0.1,
      softLightHighlightClamp: 0.16,
      floorGlowBase: 0.15,
      floorGlowAmp: 0.14,
      laneGlowBase: 0.14,
      laneGlowAmp: 0.14,
  ...
  high: {
    ...
    post: {
      ...
      safeZoneEnabled: true,
      softLightEnabled: true,
      softLightStrength: 0.3,
      softLightContrast: 0.14,
      softLightSaturation: 0.08,
      softLightHighlightClamp: 0.1,
      floorGlowBase: 0.11,
      floorGlowAmp: 0.09,
      laneGlowBase: 0.095,
      laneGlowAmp: 0.11,
  ...
  medium: {
    ...
    post: {
      ...
      safeZoneEnabled: false,
      softLightEnabled: false,
      softLightStrength: 0.18,
      softLightContrast: 0.08,
      softLightSaturation: 0.04,
      softLightHighlightClamp: 0.08,
      floorGlowBase: 0.11,
      floorGlowAmp: 0.09,
      laneGlowBase: 0.09,
  ...
  low: {
    ...
    post: {
      ...
      safeZoneEnabled: false,
      softLightEnabled: false,
      softLightStrength: 0.14,
      softLightContrast: 0.06,
      softLightSaturation: 0.03,
      softLightHighlightClamp: 0.07,
      floorGlowBase: 0.1,
      floorGlowAmp: 0.08,
      laneGlowBase: 0.08,
      laneGlowAmp: 0.1,
